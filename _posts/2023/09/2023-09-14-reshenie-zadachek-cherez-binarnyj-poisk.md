...
<h2 id="find-root"><span class="attention">Поиск</span> степени числа</h2>

Рассмотрим решение задачи на поиск степени числа.

**Например:** 2 ^ X = 16 => 4 так как 2 ^ 4 = 16
